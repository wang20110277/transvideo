    ...
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <div className="h-16 border-b border-border bg-panel px-8 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-4">
          <img src="./logo.png" alt="TRANSVIDEO Logo" className="w-10 h-10" />
          <div>
            <h1 className="text-lg font-bold text-foreground tracking-wide">TRANSVIDEO</h1>
            <p className="text-[10px] text-muted-foreground uppercase tracking-widest">trans video Studio</p>
          </div>
        </div>
